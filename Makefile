...
GAME_TITLE	:= WolveSlayer
GAME_SUBTITLE	:= Christian Hoffmann
GAME_AUTHOR	:= Ver 1.00
GAME_ICON	:= logo.bmp
...
DEFINES		:=
# Note: Don't use `-DPICOLIBC_LONG_LONG_PRINTF_SCANF`, we need to be able to
# read floating point values from text files.

# Libraries
# ---------

ARM7ELF		:= $(BLOCKSDS)/sys/arm7/main_core/arm7_libxm7.elf
